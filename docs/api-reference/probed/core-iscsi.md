...
**Parameters:**
- `api` (required): `SYNO.Core.ISCSI.FCTarget`
- `version` (required): `1`
- `method` (required): `get`
- `_sid` (required): Session ID from `SYNO.API.Auth`

Confirmed present: DSM returned error 18990710 rather than 103, so the method exists. What it additionally requires was not determined.
...
**Parameters:**
- `api` (required): `SYNO.Core.ISCSI.Host`
- `version` (required): `1`
- `method` (required): `get`
- `_sid` (required): Session ID from `SYNO.API.Auth`

Confirmed present: DSM returned error 18990004 rather than 103, so the method exists. What it additionally requires was not determined.
The exact signature was not determined; it is listed here so it is known to exist.
...
**Parameters:**
- `api` (required): `SYNO.Core.ISCSI.Lunbkp`
- `version` (required): `1`
- `method` (required): `get`
- `_sid` (required): Session ID from `SYNO.API.Auth`
...
**Parameters:**
- `api` (required): `SYNO.Core.ISCSI.Node`
- `version` (required): `1`
- `method` (required): `get`
- `_sid` (required): Session ID from `SYNO.API.Auth`
...
**Parameters:**
- `api` (required): `SYNO.Core.ISCSI.Replication`
- `version` (required): `1`
- `method` (required): `get`
- `_sid` (required): Session ID from `SYNO.API.Auth`

Confirmed present: DSM returned error 18990831 rather than 103, so the method exists. What it additionally requires was not determined.
The exact signature was not determined; it is listed here so it is known to exist.
...
**Parameters:**
- `api` (required): `SYNO.Core.ISCSI.Target`
- `version` (required): `1`
- `method` (required): `get`
- `_sid` (required): Session ID from `SYNO.API.Auth`
...
**Parameters:**
- `api` (required): `SYNO.Core.ISCSI.VMware`
- `version` (required): `1`
- `method` (required): `list`
- `_sid` (required): Session ID from `SYNO.API.Auth`
