...
**Parameters:**
- `api` (required): `SYNO.S2S.Client.Job`
- `version` (required): `1`
- `method` (required): `get`
...
**Parameters:**
- `api` (required): `SYNO.S2S.Server.Pair`
- `version` (required): `1`
- `method` (required): `get`
- `_sid` (required): Session ID from `SYNO.API.Auth`
...
from this probe (`synology-api/synology_api/core_sys_info.py:1614`):
- `additional` (required)
