...
**Parameters:**
- `api` (required): `SYNO.Core.MyDSCenter`
- `version` (required): `2`
...
**Parameters:**
- `api` (required): `SYNO.Core.MyDSCenter.Account`
- `version` (required): `1`
- `method` (required): `get`
- `_sid` (required): Session ID from `SYNO.API.Auth`
...
**Parameters:**
- `api` (required): `SYNO.Core.MyDSCenter.Purchase`
- `version` (required): `1`
- `method` (required): `list`
- `_sid` (required): Session ID from `SYNO.API.Auth`

Confirmed present: DSM returned error 3000 rather than 103, so the method exists. What it additionally requires was not determined.
