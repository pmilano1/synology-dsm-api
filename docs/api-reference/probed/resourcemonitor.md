...
**Parameters:**
- `api` (required): `SYNO.ResourceMonitor.EventRule`
- `version` (required): `1`
- `method` (required): `get`
...
**Parameters:**
- `api` (required): `SYNO.ResourceMonitor.Log`
- `version` (required): `1`
- `method` (required): `list`
- `_sid` (required): Session ID from `SYNO.API.Auth`

Additional parameters, from open-source client implementations rather than
from this probe (`synology-api/synology_api/core_sys_info.py:1884`):
- `limit` (required)
- `mode` (required)
- `offset` (required)
- `sort_by` (required)
...
**Parameters:**
- `api` (required): `SYNO.ResourceMonitor.Setting`
- `version` (required): `1`
- `method` (required): `get`
- `_sid` (required): Session ID from `SYNO.API.Auth`
