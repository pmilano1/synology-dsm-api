# Core · PortForwarding APIs (probed)
...
**Parameters:**
- `api` (required): `SYNO.Core.PortForwarding.RouterConf`
- `version` (required): `1`
- `method` (required): `get`
...
**Parameters:**
- `api` (required): `SYNO.Core.PortForwarding.RouterInfo`
- `version` (required): `1`
- `method` (required): `get`
- `_sid` (required): Session ID from `SYNO.API.Auth`
...
```json
{
  "success": true,
  "data": {
    "otherDeviceUsed": "integer",
    "otherDeviceUsedTCPPorts": "array<empty>",
    "otherDeviceUsedUDPPorts": "array<empty>"
  }
}
```
...
**Parameters:**
- `api` (required): `SYNO.Core.PortForwarding.RouterList`
- `version` (required): `1`
- `method` (required): `get`
- `_sid` (required): Session ID from `SYNO.API.Auth`
