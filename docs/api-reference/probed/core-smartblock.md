...
**Parameters:**
- `api` (required): `SYNO.Core.SmartBlock`
- `version` (required): `1`
- `method` (required): `get`
...
```json
{
  ...
  "data": {
    "enabled": "boolean",
    "trust_lock": "integer",
    "trust_minute": "integer",
    "trust_try": "integer",
    "untrust_lock": "integer",
    "untrust_minute": "integer",
    "untrust_try": "integer"
  }
}
```
...
**Parameters:**
- `api` (required): `SYNO.Core.SmartBlock.Device`
- `version` (required): `1`
- `method` (required): `get`
- `_sid` (required): Session ID from `SYNO.API.Auth`
...
**Parameters:**
- `api` (required): `SYNO.Core.SmartBlock.Trusted`
- `version` (required): `1`
...
**Parameters:**
- `api` (required): `SYNO.Core.SmartBlock.Untrusted`
- `version` (required): `1`
- `method` (required): `list`
- `_sid` (required): Session ID from `SYNO.API.Auth`
...
**Parameters:**
- `api` (required): `SYNO.Core.SmartBlock.User`
- `version` (required): `1`
- `method` (required): `list`
- `_sid` (required): Session ID from `SYNO.API.Auth`
