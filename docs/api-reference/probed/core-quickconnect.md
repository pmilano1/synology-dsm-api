...
**Parameters:**
- `api` (required): `SYNO.Core.QuickConnect.Permission`
- `version` (required): `1`
- `method` (required): `get`
...
**Parameters:**
- `api` (required): `SYNO.Core.QuickConnect.RegisterSite`
- `version` (required): `1`
- `method` (required): `get`
- `_sid` (required): Session ID from `SYNO.API.Auth`
...
**Parameters:**
- `api` (required): `SYNO.Core.QuickConnect.Upnp`
- `version` (required): `1`
- `method` (required): `get`
- `_sid` (required): Session ID from `SYNO.API.Auth`
